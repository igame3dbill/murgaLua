...
if lfs.attributes(pathToMurgaLua ..fileName) ~= nil then fileName = pathToMurgaLua ..fileName end

-- if the file exists at same path as script
if lfs.attributes(CurDir..fileName) ~= nil  then fileName =CurDir..fileName end
...
scriptEditor:label("Script Editor")
...
path:label("Current File:")
path:resize(95,15,370,25)
end
