...
desaturate=fltk:Fl_Button(30,266,300,30,"desaturate")
desaturate:callback(function(desat_cb)
xpm_data:desaturate()
xpm_box:redraw_label()
end
)
inactive=fltk:Fl_Button(30,296,300,30,"inactive")
inactive:callback(function(inact_cb)
xpm_data:inactive()
xpm_box:redraw_label()
end
)
reset=fltk:Fl_Button(30,326,300,30,"reset")
...
color_button=fltk:Fl_Button(330,326,30,30,"@<-  color_average()")
...
color_slider=fltk:Fl_Value_Slider(330,30,30,296)
