...
file_chooser_output=fltk:Fl_Output(10,40,350,30)
file_chooser_button=fltk:Fl_Return_Button(10,10,200,30,"fltk.fl_file_chooser")
file_chooser_toggle=fltk:Fl_Light_Button(210,10,150,30,"use relative path")
