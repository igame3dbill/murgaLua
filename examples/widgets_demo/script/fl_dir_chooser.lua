...
dir_chooser_output=fltk:Fl_Output(10,40,350,30)
dir_chooser_button=fltk:Fl_Return_Button(10,10,200,30,"fltk.fl_dir_chooser")
dir_chooser_toggle=fltk:Fl_Light_Button(210,10,150,30,"use relative path")
